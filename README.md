...
- `/` 홈 — 오늘의 팬 질문, HOT 팬 의견, 내 Y포인트, 최근 구단 피드백
- `/polls` 팬 설문 — 1~3문항 짧은 설문, 참여 시 +5 YP, 참여 후 결과 비율 표시
- `/voices` 팬 의견 — 카테고리별 의견 작성(+10 YP), 공감(+1 YP), 공감 20+ HOT 표시, 최신순/인기순
- `/mypage` 마이페이지 — 보유 Y포인트, 참여한 설문/작성한 의견/공감 내역, 포인트 적립 내역
